...
USE BI_VENTAS
SELECT  top 10 * FROM dbo.PCPCOHD0 
SELECT  top 10 * FROM dbo.PCPCOPD0 

SELECT TOP 10 * FROM PCPCOHD0 WHERE RFDCNO LIKE '%00Q%' ORDER BY ENDT8 DESC--TABLA Maestra
SELECT  * FROM PCPCOPD0 WHERE RFDCNO = '00E028602'; --TABLA Detalle
